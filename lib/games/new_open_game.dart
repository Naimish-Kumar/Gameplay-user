                                      ...
                                      children: [
                                        TableRow(children: [
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(2),
                                            child: DesignText.bold2(
                                              'Winner: ${game.tournamentWinRewards}',
                                              fontSize: 14,
                                              color:
                                                  darkModeProvider.isDarkTheme
                                                      ? Colors.white
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(2),
                                            child: DesignText.bold2(
                                              'Perkill: ${game.tournamentSingleRewards}',
                                              fontSize: 14,
                                              color:
                                                  darkModeProvider.isDarkTheme
                                                      ? Colors.white
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (!functionplayerGameIDforAddGame
                                                                            ...
                                                                            if (userData.coins - game.fee <=
                                                                              ...
                                                                              await FirestoreService().updateJoining(game, _addMoney.text).whenComplete(() => FirestoreService().updateWallet(-game.fee, 'Join Match no: ${game.id}', DateTime.now().toString(), '', '', '', true)).whenComplete(() => Navigator.pop(context)).whenComplete(() => Fluttertoast.showToast(msg: "SUCCESS", toastLength: Toast.LENGTH_LONG));
                                                                            }
                                                                          } else {
                                                                            Fluttertoast.showToast(
